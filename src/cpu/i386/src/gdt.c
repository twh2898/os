...
void gdt_init() {
    ...
    gdt_set(&gdt[GDT_ENTRY_INDEX_USER_CODE], 0, 0xfffff, GDT_PRESET_USER_CODE_ACCESS, GDT_PRESET_USER_CODE_FLAGS);
    gdt_set(&gdt[GDT_ENTRY_INDEX_USER_DATA], 0, 0xfffff, GDT_PRESET_USER_DATA_ACCESS, GDT_PRESET_USER_DATA_FLAGS);
    gdt_set(&gdt[GDT_ENTRY_INDEX_KERNEL_TSS], 0, 0xfffff, GDT_PRESET_KERNEL_TSS_ACCESS, GDT_PRESET_KERNEL_TSS_FLAGS);
    gdt_set(&gdt[GDT_ENTRY_INDEX_USER_TSS], 0, 0xfffff, GDT_PRESET_USER_TSS_ACCESS, GDT_PRESET_USER_TSS_FLAGS);
