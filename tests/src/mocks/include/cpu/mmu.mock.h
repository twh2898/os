...
DECLARE_FAKE_VALUE_FUNC(int, mmu_dir_set_flags, mmu_dir_t *, size_t, uint32_t);
DECLARE_FAKE_VALUE_FUNC(int, mmu_dir_set, mmu_dir_t *, size_t, uint32_t, uint32_t);
DECLARE_FAKE_VALUE_FUNC(uint32_t, mmu_dir_get_addr, mmu_dir_t *, size_t);
DECLARE_FAKE_VALUE_FUNC(uint32_t, mmu_dir_get_flags, mmu_dir_t *, size_t);
DECLARE_FAKE_VALUE_FUNC(int, mmu_table_set_addr, mmu_table_t *, size_t, uint32_t);
DECLARE_FAKE_VALUE_FUNC(int, mmu_table_set_flags, mmu_table_t *, size_t, uint32_t);
