...
DECLARE_FAKE_VALUE_FUNC(int, paging_add_pages, size_t, size_t);
DECLARE_FAKE_VALUE_FUNC(int, paging_remove_pages, size_t, size_t);
DECLARE_FAKE_VALUE_FUNC(int, paging_add_table, size_t);
DECLARE_FAKE_VALUE_FUNC(int, paging_remove_table, size_t);
