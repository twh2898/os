...
DEFINE_FAKE_VALUE_FUNC(int, paging_add_pages, uint32_t, size_t, size_t);
DEFINE_FAKE_VALUE_FUNC(int, paging_remove_pages, uint32_t, size_t, size_t);
DEFINE_FAKE_VALUE_FUNC(int, paging_add_table, uint32_t, size_t);
DEFINE_FAKE_VALUE_FUNC(int, paging_remove_table, uint32_t, size_t);
