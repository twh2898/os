...
DEFINE_FAKE_VALUE_FUNC(int, paging_add_pages, size_t, size_t);
DEFINE_FAKE_VALUE_FUNC(int, paging_remove_pages, size_t, size_t);
DEFINE_FAKE_VALUE_FUNC(int, paging_add_table, size_t);
DEFINE_FAKE_VALUE_FUNC(int, paging_remove_table, size_t);
